...
function renderTopic(id){const m=DATA.modules.find(x=>x.id===id);let body='';
  ...
  else if(id==='regional')body=diagnosisCoverage('regional')+caseSimulator()+imageAtlas(['knee','regional','upper','redhot'])+regionalRows()+sortRows(3)+diseaseMini(['Knee osteoarthritis','ACL tear','PCL tear','Meniscal tear','Patellofemoral pain syndrome','Prepatellar bursitis','Osgood-Schlatter disease','Baker cyst','Iliotibial band syndrome','Monoarticular arthritis','Scoliosis','Intervertebral disc herniation','Discitis','Musculoskeletal low back pain','Developmental dysplasia of the hip','Legg-Calve-Perthes disease','Slipped capital femoral epiphysis','Trochanteric bursitis','Osteonecrosis of the hip','Meralgia paresthetica','Medial/lateral epicondylitis','Scaphoid fracture','Rotator cuff tear','Little League shoulder','Dupuytren contracture']);
